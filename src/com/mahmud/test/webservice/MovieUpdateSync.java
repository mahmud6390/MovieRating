...
public abstract class MovieUpdateSync extends AsyncTask<String, Integer, String> implements IHttpResponseListener
{
	private String MOVIE_ID="movie_id";
	private String RATING_ID="rating_id";
	...
	protected String doInBackground(String... urls) 
	{
		...
		String movieId=urls[6];
		String ratingId=urls[7];
		...
		reqEntity.addPart(MOVIE_ID, new StringBody(movieId));
		reqEntity.addPart(RATING_ID, new StringBody(ratingId));
		}
		catch(Exception e)
		{
			e.printStackTrace();
